...
local lib = actualLib:Load({name = "ClipboardOfLenaki", sizeX = 425, sizeY = 510, color = Color3.fromRGB(37, 15, 134)})
-- \\ T510
...
Info:Label("Script: lenakiClipboardW")
